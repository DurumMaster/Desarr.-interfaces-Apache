...
public class MainFrame extends javax.swing.JFrame {
    ...
    public void aniadirCliente(Clientes cliente) {
        ...
        model.addRow(crearArrayStrings(cliente));
    }
    
    public String[] crearArrayStrings(Clientes cliente) {
        String[] s = new String[7];
        s[0]= cliente.getNombre();
        s[1]= cliente.getApellido();
        s[2]= cliente.getEmail();
        s[3]= cliente.getDireccion();
        s[4]= cliente.getFechaAlta().toString();
        s[5]= cliente.getProvincia();
        s[6]= cliente.getCiudad(); 
    ...
    private void initComponents() {
        ...
        jMenuGestionCliente.setText("Gestión");
        ...
        jMenuGestionCliente.add(jMenuItemAltaCliente);
    ...
    private void jMenuItemAltaClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemAltaClienteActionPerformed
        // Muestro el cuadro de diálogo de alta de clientes al pulsar el menuú de nueva alta
        DialogoAltaCliente dialogAlta = new DialogoAltaCliente(this, true);
